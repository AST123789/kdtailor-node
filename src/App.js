...
const InsertCustomerData= async(req)=>{
    ...
    // </div>
        ...
        <div className="inner_content" style={{padding:'0rem'}}>
                        ...
                        <div className="signin-form profile admin">
                            ...
                            <div className="login-form">
                                <form method="post">
                                    ...
                                    <button onClick={(e)=>submit(e)} style={{color:'#fff'}}>
                ...
                <div className="copyrights">
                    {/* <p>© 2022 KD Tailor. All Rights Reserved | Design by  <button to="http://digitalcreaters.com/" target="_blank">Digital Creaters</Link> </p> */}
                </div>
                {/* <Footer/> */}
                </>
  );
